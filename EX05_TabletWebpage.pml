...
<Package name="EX05_TabletWebpage" format_version="4">
    ...
    <Dialogs>
        ...
        <Dialog name="introduction_dialog" src="introduction_dialog/introduction_dialog.dlg" />
    </Dialogs>
    <Resources>
        ...
        <File name="learnASL" src="html/pages/learnASL.html" />
        <File name="learnLetter" src="html/pages/learnLetter.html" />
        <File name="letterDynamicShow" src="html/pages/letterDynamicShow.html" />
        <File name="translateASL" src="html/pages/translateASL.html" />
        <File name="SignBackground" src="html/pics/SignBackground.jpg" />
        <File name="usek-logo-png" src="html/pics/usek-logo-png.png" />
        <File name="letterASL" src="html/css/letterASL.css" />
    </Resources>
    <Topics>
        ...
        <Topic name="introduction_dialog_enu" src="introduction_dialog/introduction_dialog_enu.top" topicName="introduction_dialog" language="en_US" />
    </Topics>
    <IgnoredPaths />
